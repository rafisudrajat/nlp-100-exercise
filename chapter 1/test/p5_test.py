...
class TestP5Chapter1(unittest.TestCase):
    @parameterized.expand([
        ...
        ("I am a Stanford University Student majoring in mechatronics",
            [("I", "am"), ("am", "a"), ("a", "Stanford"), ("Stanford", "University"),
                ("University", "Student"), ("Student", "majoring"), ("majoring", "in"), ("in", "mechatronics")]
         )
    ])
    def test_should_generate_word_bigram(
    ...
    @parameterized.expand([
        ...
        ("I am an Engineering Student",
            ["Ia", "am", "ma", "an", "nE", "En", "ng", "gi", "in", "ne", "ee",
                "er", "ri", "in", "ng", "gS", "St", "tu", "ud", "de", "en", "nt"]
         )
    ])
    def test_should_generate_letter_bigram(
